...
<head>
    ...
    <style type="text/tailwindcss">
        ...
        input, 
        textarea {
            @apply shadow-sm appearance-none border w-full resize-none py-2 px-3 text-slate-700 leading-tight focus:outline-none focus:outline-none;
        }
...
<body class="container mx-auto mt-10 mb-10 max-w-lg">
    <h1 class="mb-4 text-xxl text-center font-bold">@yield('title')</h1>
